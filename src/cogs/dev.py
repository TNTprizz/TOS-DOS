...
class dev(commands.Cog): # Show that it is a discord Cog object
    ...
    async def rmcog(self, ctx, cogname: str):
        if ctx.author.id != 469038475371479041: # If author is not TNTprizz
            raise commands.NotOwner("You are not the Owner of this bot") # Raise exception
